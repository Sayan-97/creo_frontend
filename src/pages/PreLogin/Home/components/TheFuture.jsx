...
import BGImg from '../../../../assets/img/FindWorkImage.png'
import BGGrad from '../../../../assets/gradients/TheFutureGrad.png'
...
const TheFuture = () => {
    ...
    return (
        <div className='relative'>
            <img src={BGGrad} alt="img" className='absolute right-0 -top-[45%] w-[70%] opacity-60'/>
            <div className='container flex max-lg:flex-col-reverse max-lg:gap-12 items-center justify-between gap-4 relative z-10'>
                <div className='grid gap-3 lg:w-[50%]'>
                    <span className='text-xl uppercase font-semibold bg-gradient text-transparent bg-clip-text'>Unlocking The Future</span>
                    <h3 className='leading-snug'>Cutting-Edge Tech Stack<br /> Behind Our Web App!</h3>
